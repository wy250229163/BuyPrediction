DROP TABLE IF EXISTS wy1_f3_t1;
CREATE TABLE wy1_f3_t1 AS 
...
DROP TABLE IF EXISTS wy1_f3_t2;
CREATE TABLE wy1_f3_t2 AS 
SELECT user_id ,item_id,
...
DROP TABLE IF EXISTS wy1_f3_t3;
CREATE TABLE wy1_f3_t3 AS 
SELECT user_id ,item_id,
...
DROP TABLE IF EXISTS wy1_f3_t4_1;
CREATE TABLE wy1_f3_t4_1 AS 
SELECT user_id , item_id ,
...
DROP TABLE IF EXISTS wy1_f3_t4_2;
CREATE TABLE wy1_f3_t4_2 AS 
SELECT user_id , item_id,
...
DROP TABLE IF EXISTS wy1_f3_t4_3;
CREATE TABLE wy1_f3_t4_3 AS 
SELECT user_id , item_id,
...
DROP TABLE IF EXISTS wy1_f3_t5;
CREATE TABLE wy1_f3_t5 AS 
...
DROP TABLE IF EXISTS wy1_f3_t6;
CREATE TABLE wy1_f3_t6 AS 
SELECT a.user_id,a.item_id,datediff(to_date("2014-12-18","yyyy-mm-dd"),a.dodate,"dd") AS user_item_firstact_diffdays FROM
(SELECT user_id,item_id,dodate, ROW_NUMBER() OVER (PARTITION BY user_id,item_id ORDER BY dodate) AS num 
FROM user_item_detail WHERE dodate>=to_date("2014-11-18","yyyy-mm-dd") AND dodate<=to_date("2014-12-17","yyyy-mm-dd") ) a
WHERE a.num=1;

DROP TABLE IF EXISTS wy1_f3_t7;
CREATE TABLE wy1_f3_t7 AS 
SELECT a.user_id,a.item_id,datediff(to_date("2014-12-18","yyyy-mm-dd"),a.dodate,"dd") AS user_item_recently_view_diffdays FROM
(SELECT user_id,item_id,dodate, ROW_NUMBER() over (PARTITION BY user_id,item_id ORDER BY dodate DESC) AS num 
FROM user_item_detail WHERE doview=1 AND dodate>=to_date("2014-11-18","yyyy-mm-dd") AND dodate<=to_date("2014-12-17","yyyy-mm-dd") ) a
WHERE a.num=1;

DROP TABLE IF EXISTS wy1_f3_t8;
CREATE TABLE wy1_f3_t8 AS 
SELECT a.user_id,a.item_id,datediff(to_date("2014-12-18","yyyy-mm-dd"),a.dodate,"dd") AS user_item_recently_favor_diffdays FROM
(SELECT user_id,item_id,dodate, ROW_NUMBER() over (PARTITION BY user_id,item_id ORDER BY dodate DESC) AS num 
FROM user_item_detail WHERE dofavor=1 AND dodate>=to_date("2014-11-18","yyyy-mm-dd") AND dodate<=to_date("2014-12-17","yyyy-mm-dd") ) a
WHERE a.num=1;

DROP TABLE IF EXISTS wy1_f3_t9;
CREATE TABLE wy1_f3_t9 AS 
SELECT a.user_id,a.item_id,datediff(to_date("2014-12-18","yyyy-mm-dd"),a.dodate,"dd") AS user_item_recently_addcar_diffdays FROM
(SELECT user_id,item_id,dodate, ROW_NUMBER() over (PARTITION BY user_id,item_id ORDER BY dodate DESC) AS num 
FROM user_item_detail WHERE doaddcar=1 AND dodate>=to_date("2014-11-18","yyyy-mm-dd") AND dodate<=to_date("2014-12-17","yyyy-mm-dd") ) a
WHERE a.num=1;

DROP TABLE IF EXISTS wy1_f3_t10;
CREATE TABLE wy1_f3_t10 AS 
SELECT a.user_id,a.item_id,datediff(to_date("2014-12-18","yyyy-mm-dd"),a.dodate,"dd") AS user_item_recently_buy_diffdays FROM
(SELECT user_id,item_id,dodate, ROW_NUMBER() over (PARTITION BY user_id,item_id ORDER BY dodate DESC) AS num 
FROM user_item_detail WHERE dobuy=1 AND dodate>=to_date("2014-11-18","yyyy-mm-dd") AND dodate<=to_date("2014-12-17","yyyy-mm-dd") ) a
WHERE a.num=1;

DROP TABLE IF EXISTS wy1_f3;
CREATE TABLE wy1_f3 AS 
